...
#PJM --rsc-list "rscgrp=eap-large" # Job class     
#### --rsc-list "node=640"         # Number of nodes
#PJM --rsc-list "node=5x16x8"         # Number of nodes
#PJM --rsc-list "elapse=10:00:00"  # Execute time
#PJM --mpi "proc=2560"             # Number of MPI (= Number of nodes x 4)

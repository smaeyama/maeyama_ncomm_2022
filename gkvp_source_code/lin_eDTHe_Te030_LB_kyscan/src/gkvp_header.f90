...
!  in kx,ky,z,v,m (   -nx:nx,0:global_ny,-global_nz:global_nz-1,1:2*global_nv,0:global_nm)
  ...
  integer, parameter :: nxw = 32, nyw = 32
  integer, parameter :: nx = 7, global_ny = 1 ! 2/3 de-aliasing rule
  integer, parameter :: global_nz = 20, global_nv = 32, global_nm = 15
...
!--------------------------------------
  ...
  integer, parameter :: nprocw = 1, nprocz = 2, nprocv = 2, nprocm = 2, nprocs = 4
